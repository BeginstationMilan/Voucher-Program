...
class LoginScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Create a label widget for displaying the account type
        self.account_type_label = Label(text="Logged in as: ", size_hint=(None, None), size=(200, 50), pos_hint={'center_x': 0.5, 'center_y': 0.5})
    ...
    def set_logged_in_type(self, account_type):
        # Set the account type in the App class
        app = App.get_running_app()
        app.account_type = account_type

    def logged_in_type(self):
        return self.account_type_label.text.split(":")[-1].strip()
    ...
    def switch_to_main(self):
        show_success_popup("Login","Login Succesfull" )
